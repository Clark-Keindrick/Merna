<?php
    ...
    $total_sold = total_sold_items('LLC');
?>
...
<body>
    <div class="header">
        <div class="text">Lapu-Lapu Branch Daily Item Sold</div>
   ...
   <div class="row page-path">
    ...
    <main>
        <div class="inv_header bg-success text-light">
            <h3 class="inv_label">LLC Branch Daily Item Sold</h3>
