    ...
    <main>
        ...
        <div class="item_pic_container">
            <div class="pic-container">
                <img src="../Inventory_Pic/<?php echo $item_pic; ?>" alt="">
                <h4><?php echo $desc; ?></h4>
            </div>

            <div class="upload-container">
                <div class="panel panel2 panel-info">
                    <div class="panel-heading panel-heading2">
                        Upload New Inventory Item Pic
                    </div>
                    <form action="" method="POST" class="form-signin" enctype="multipart/form-data">
                        <div class="panel-body panel-body2">
                                <label for="file">Select image</label><br>
                                <input type="file" name="itemPhoto"><br>
                        </div>
                        <div class="panel-footer panel-footer2">
                            <button class="btn btn-primary" name="update_item_pic" type="submit">Change</button>&nbsp;&nbsp;
                            <a type="button" class="btn btn-default" href="LLCInventory.php">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
